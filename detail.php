...
<html lang="en">
    <head>
        ...
        <title>Home - LET'S CHIT CHATT!</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <div class="container">
             ...
             $data_potongan_isi = potong_artikel($data_isi, 250);
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary" href="detail.php?id_kontributor=<?php echo urlencode($data_id_kontributor); ?>&id_kategori=<?php echo urlencode($data_id_kategori); ?>">Read more</a>
         ...
         if(mysqli_num_rows($result_pos2) > 0){
             ...
             $data_id_kategori = $row['id_kategori'];
             $data_isi = $row['isi'];
             $data_potongan_isi = potong_artikel($data_isi, 150);
                     ?>
                        <div class="col-lg-6">
                            <!-- Blog post-->
                            <div class="card mb-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="input-group">
                                <input class="form-control" type="text" placeholder="Insert the key word.." aria-label="Enter search term..." aria-describedby="button-search" />
